...
mod macos_real_provider_m02 {
    ...
    fn revoke_bash_accessibility_via_native_ax() -> Result<(), String> {
        Err("native AX revoke helper not implemented".to_owned())
    }
    ...
    fn m02_permission_revoked_mid_session_invalidates_prior_semantic_authority() {
        ...
        let record = serde_json::json!({
            ...
            "native_ax_bash_switch_pressed_mid_session": true,
            ...
            "authority_source": "provider_owned_dispatch_recheck_after_native_ax_system_settings_revoke",
        });
        fs::write(
