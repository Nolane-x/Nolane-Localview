...
''',
    '''                IUIAutomationSelectionItemPattern, IUIAutomationTogglePattern,
                IUIAutomationTreeWalker, IUIAutomationValuePattern,
                UIA_ExpandCollapsePatternId, UIA_InvokePatternId,
''',
    "ValuePattern interface import",
)
...
''',
    ...
    impl Drop for WindowsUiaWorker {
''',
    "public worker dispatch_set_value",
)
...
if text.count(marker) != 1:
    raise SystemExit(f"worker state insertion marker count={text.count(marker)}")
