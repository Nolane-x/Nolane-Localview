...
fn ready() -> SettleObservation {
    SettleObservation {
        now_unix_ms: 10_000,
        latest_semantic_at_unix_ms: Some(9_900),
        ready_state: Some("complete".into()),
        fonts_status: Some("loaded".into()),
        pending_images: Some(0),
        latest_hmr_at_unix_ms: Some(9_000),
        latest_dom_mutation_at_unix_ms: Some(9_000),
        latest_layout_at_unix_ms: Some(9_000),
        latest_network_at_unix_ms: Some(9_000),
    }
}
