...
impl Default for PermissionPolicy {
    fn default() -> Self {
        Self {
            allowed: [Capability::Observe].into_iter().collect(),
        }
    }
}
...
impl SecretRedactor {
    pub fn redact(&self, input: &str) -> String {
        self.patterns.iter().fold(input.to_owned(), |text, re| {
...
mod tests {
    ...
    fn redacts_bearer() {
        ...
        assert_eq!(
            r.redact("Authorization: Bearer abc123"),
